...
void Play::setup(){
    ...
    simpleCam.setDeviceID(0); //guardo dove stampa il num device
    cout << "*************************" << endl;
...
void Play::setupGui() {
    ...
    doFullScreen.addListener(this, &Play::setFullScreen);
    ...
    drawMode.addListener(this, &Play::drawModeSetName);
    ...
    displayScalarScale.addListener(this, &Play::setDisplayScalarScale);
    visualizeParameters.add(velocityFieldScale.set("velocity scale", 0.1, 0.0, 0.5));
    velocityFieldScale.addListener(this, &Play::setVelocityFieldScale);
    visualizeParameters.add(temperatureFieldScale.set("temperature scale", 0.1, 0.0, 0.5));
    temperatureFieldScale.addListener(this, &Play::setTemperatureFieldScale);
    visualizeParameters.add(pressureFieldScale.set("pressure scale", 0.02, 0.0, 0.5));
    pressureFieldScale.addListener(this, &Play::setPressureFieldScale);
    visualizeParameters.add(velocityLineSmooth.set("line smooth", false));
    velocityLineSmooth.addListener(this, &Play::setVelocityLineSmooth);
...
void Play::update(){
   ...
   // drawMode = DRAW_COMPOSITE; //aggiunta
...
void Play::keyPressed(int key){
    switch (key) {
        ...
        //case 'S':
        //case 's': img.grabScreen(0, 0, ofGetWidth(), ofGetHeight());
...
//--------------------------------------------------------------
void Play::drawModeSetName(int &_value) {
    switch(_value) {
...
//--------------------------------------------------------------
void Play::drawComposite(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void Play::drawParticles(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void Play::drawFluidFields(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void Play::drawFluidDensity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void Play::drawFluidVelocity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofClear(0,0);
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void Play::drawFluidPressure(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofClear(128);
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawFluidTemperature(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawFluidDivergence(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawFluidVorticity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawFluidBuoyance(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawFluidObstacle(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawMask(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawOpticalFlow(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void Play::drawSource(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void Play::drawMouseForces(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofClear(0,0);
    ...
    for(int i=0; i<mouseForces.getNumForces(); i++) {
        ofEnableBlendMode(OF_BLENDMODE_ADD);
        if (mouseForces.didChange(i)) {
            flowTools::ftDrawForceType dfType = mouseForces.getType(i);
            if (dfType == flowTools::FT_DENSITY)
...
//--------------------------------------------------------------
void Play::drawVelocityDots(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_ADD);
